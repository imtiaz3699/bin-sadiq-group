...
<div  className="px-36 w-full h-[600px] flex flex-row items-center  justify-center text-[28px] bg-lead-color text-white"  
// style = {{backgroundImage:'url(/About-01.jpg)'}}
>
...
<div className="bg-lead-color py-20 flex flex-col gap-10 items-center justify-center text-white">
...
<div className="py-20 flex flex-col gap-10 items-center justify-center text-white bg-lead-color">
