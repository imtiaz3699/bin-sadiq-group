              ...
              <div className='grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 place-items-center mt-[150px] gap-[50px] sm:gap-[100px] w-full px-5'>
                {
                  ourServices.map((element, idx) => {
                    return <div className={`transition-transform duration-500 ease-in-out transform hover:scale-[1.1] w-full sm:w-[342px] shadow-2xl drop-shadow-2xl" px-5 py-5 h-auto  flex flex-col items-center justify-center bg-golden rounded-[12px]`} key={idx} onMouseEnter={() => setState(idx)}>
